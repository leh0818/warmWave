...
const ArticleList = () => {
    ...
    const ProductCard = ({articleId, title, articleType, imageUrl, writer, category, postDate }) => (
            ...
            <div className="card h-100" style={{ width: "110%" }}>
                    ...
                    <div className="card-body p-4 mb-2">
                        <div className="text-left">
                            ...
                            <hr className="my-1" />
                            <p className="mb-1"><strong>Writer:</strong> {writer}</p> <br/>
                            <strong>Category:</strong> <span className="badge bg-secondary mx-1">{category}</span>
                        </div>
                        <br/>
